...
time_delay_min = 10                                                    # Минимальная и
time_delay_max = 20                                                    # Максимальная задержка между ТРАНЗАКЦИЯМИ
...
MINT_NFT       = True             # Минт НФТ
TRANSFER_NFT   = True             # Отправка нфт самому себе
